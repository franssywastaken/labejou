  ...
  return (
    <section className="py-20 md:py-32 px-6 bg-neutral-cream">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-center text-mountain-charcoal mb-12 text-lg">🛏️ 16 rooms — book with intention</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <label className="block text-mountain-dark font-serif mb-2">☎️ Phone</label>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <a href={`mailto:${HOTEL_INFO.email}`} className="flex items-center gap-3 p-4 bg-white rounded-lg border border-mountain-charcoal/10 hover:border-hospitality-orange hover:bg-neutral-light transition-all">
                <span className="text-2xl">📧</span>
                <div>
                  <p className="font-serif font-bold text-mountain-dark">Email</p>
                  <p className="text-sm text-mountain-charcoal">{HOTEL_INFO.email}</p>
                </div>
              </a>
            </div>
          </div>
